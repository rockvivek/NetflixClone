...
class HeroHeaderUIView: UIView {
    ...
    func applyConstraints() {
        ...
        let leadingConstraint = playButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant:100)
        ...
        let downloadButtonConstraints = [
            downlaodButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -100),
